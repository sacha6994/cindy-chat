...
export function AboutSection() {
  return (
    <section id="elevage" className="py-24 lg:py-32 bg-cream relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-6 relative">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-24">
          ...
          <MotionWrapper variant="slide-left" className="relative">
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -right-4 md:-right-8 bg-white p-5 rounded-2xl shadow-xl border border-warm-100"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">annees de passion</p>
                </div>
              </div>
            </motion.div>
          </MotionWrapper>
              ...
              {features.map((feature) => (
                <StaggerItem key={feature.title}>
                  <motion.div
                    ...
                    className="flex gap-4 p-4 rounded-xl bg-white/80 border border-warm-100 hover:border-warm-200 hover:shadow-md transition-all"
                  >
                    <div className="flex-shrink-0 w-11 h-11 rounded-xl bg-gradient-to-br from-primary/15 to-gold/15 flex items-center justify-center">
        ...
        {/* Stats bar */}
        <MotionWrapper>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 p-8 md:p-10 rounded-3xl bg-gradient-to-r from-primary/5 via-gold/5 to-primary/5 border border-warm-100">
            {[
