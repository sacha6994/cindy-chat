        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-white/30 text-white hover:bg-white/10 hover:border-white/50 rounded-full px-8 h-14 text-base backdrop-blur-sm transition-all hover:scale-[1.02]"
              asChild
            >
